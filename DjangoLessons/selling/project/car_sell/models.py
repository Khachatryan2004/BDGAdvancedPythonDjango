...
class CarSell(models.Model):
    ...
    mileage_type_choose = models.CharField('Mileage Measurement Types', choices=mileage_type, max_length=3, blank=True)
    ...
    currency_choose = models.CharField('', choices=currency, max_length=3)

    description = models.TextField('Description')
    photo1 = models.ImageField('Main Photo', upload_to='media/images/')
    photo2 = models.ImageField('Photo', upload_to='media/images/', blank=True, null=True)
    photo3 = models.ImageField('Photo', upload_to='media/images/', blank=True, null=True)
    photo4 = models.ImageField('Photo', upload_to='media/images/', blank=True, null=True)
    photo5 = models.ImageField('Photo', upload_to='media/images/', blank=True, null=True)
    photo6 = models.ImageField('Photo', upload_to='media/images/', blank=True, null=True)
